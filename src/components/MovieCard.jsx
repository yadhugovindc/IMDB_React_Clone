...
const MovieCard = ({ backdrop_path, name,movieObj,handlewatchlist,removewatchlist,watchlist}) => {
 ...
 let contain=(movieObj)=>{
  ...
  return (
    ...
    <div
      className="h-[35vh] w-[40vw]  lg:h-[40vh] lg:w-[11vw] bg-center bg-cover bg-no-repeat rounded-xl hover:cursor-pointer hover:scale-110 duration-300 flex flex-col justify-between items-end relative"
      style={{
